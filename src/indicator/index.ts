...
export const indicatorCategories: Record<string, { names: string[], label_zh: string, label_en: string }> = {
  trend: {
    names: ['MA', 'EMA', 'SMA', 'BOLL', 'SAR', 'BBI', 'ATR', 'SuperTrend', 'Ichimoku', 'Alligator', 'DEMA', 'TEMA', 'WMA', 'HMA', 'KAMA', 'VWMA', 'ZLEMA', 'McGinley', 'LinReg', 'Envelopes', 'T3'],
    label_zh: '趋势',
    label_en: 'Trend'
  },
  volatility: {
  ...
  volume: {
    names: ['VOL', 'OBV', 'PVT', 'VR', 'VWAP', 'MFI', 'CMF', 'AD', 'VROC', 'KVO', 'FI', 'ElderRay'],
    label_zh: '成交量',
    label_en: 'Volume'
  },
  momentum: {
    names: ['MACD', 'KDJ', 'RSI', 'BIAS', 'BRAR', 'CCI', 'DMI', 'CR', 'PSY', 'DMA', 'TRIX', 'WR', 'MTM', 'EMV', 'ROC', 'AO', 'StochRSI', 'ADX', 'Aroon', 'UltOsc', 'Fisher', 'Coppock', 'PPO', 'DPO', 'KST', 'TwiggsMF'],
    label_zh: '动量',
    label_en: 'Momentum'
  },
  other: {
